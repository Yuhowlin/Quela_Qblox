...
freq_span_range:dict = {"q0":[-350e6,150e6]}    # [freq_span_start, freq_span_end] use linspace, total span should <= 500 MHz
bias_elements:list = ["q0"]
z_amp_range:list = [-0.6, 0.6, 30]                                 # z-pulse amplitude [from, end, pts/step]
